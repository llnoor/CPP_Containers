...
TEST(Multiset, Merge) {
  ...
  s21::multiset<double> std_multiset = {-1, -6, 45, -34, 54, 23, -5, -6, -5, 0, 543, 345, 654, 35, 65};
...
TEST(Multiset, Find) {
  s21::multiset<double> s21_multiset = {-1, -6, 45, -34, 54, 23, -5, -6, -5, 0, 543, 345, 654, 35, 65};
  std::multiset<double> std_multiset = {-1, -6, 45, -34, 54, 23, -5, -6, -5, 0, 543, 345, 654, 35, 65};
