...
TEST(Map, Constructor6) {
  s21::map<int, int> temp1 = {{34, 543}, {12, 202}, {34, 3543}, {56, 454}, {76, 525}};
  std::map<int, int> temp2 = {{34, 543}, {12, 202}, {34, 3543}, {56, 454}, {76, 525}};
...
TEST(Map, At1) {
  s21::map<int, int> temp1 = {{45, 64}, {34, 543}, {123, 433}, {42, 44}, {54, 235}};
  std::map<int, int> temp2 = {{45, 64}, {34, 543}, {123, 433}, {42, 44}, {54, 235}};
  EXPECT_EQ(temp1.at(45), temp2.at(45));
}

TEST(Map, At2) {
  s21::map<int, int> temp1 = {{45, 64}, {46, 543}, {47, 433}, {48, 44}, {49, 235}};
  std::map<int, int> temp2 = {{45, 64}, {46, 543}, {47, 433}, {48, 44}, {49, 235}};
  for (size_t i = 45; i < temp1.size(); i++) EXPECT_EQ(temp1.at(i), temp2.at(i));
}
...
TEST(Map, Merge2) {
  s21::map<int, int> temp1 = {{34, 543}, {12, 202}, {34, 3543}, {56, 454}, {76, 525}};
  std::map<int, int> temp2 = {{34, 543}, {12, 202}, {34, 3543}, {56, 454}, {76, 525}};
  s21::map<int, int> temp11 = {{34, 543}, {12, 202}, {34, 3543}, {56, 454}, {76, 525}};
  std::map<int, int> temp22 = {{34, 543}, {12, 202}, {34, 3543}, {56, 454}, {76, 525}};
  temp1.merge(temp11);
  temp2.merge(temp22);
  EXPECT_EQ(temp1.size(), temp2.size());
  auto it1 = temp1.begin();
...
TEST(Map, Emplace) {
  s21::map<std::string, int> s21_map_temp = {{"Hydrogen", 1}, {"Helium", 2}, 
  {"Lithium", 3}, {"Beryllium", 4}};
  std::map<std::string, int> std_map_temp = {{"Hydrogen", 1}, {"Helium", 2}, 
  {"Lithium", 3}, {"Beryllium", 4}};
  EXPECT_EQ(s21_map_temp.size(), std_map_temp.size());
  EXPECT_EQ(s21_map_temp.empty(), std_map_temp.empty());
  auto v = s21_map_temp.emplace(std::pair<std::string, int>{"Phosphorous",25},std::pair<std::string, int>{"Sulfur",17},
                              std::pair<std::string, int>{"Chlorine",15},std::pair<std::string, int>{"Chlorine",15});
