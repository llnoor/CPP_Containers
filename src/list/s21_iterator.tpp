...
template <class T> typename list<T>::const_iterator list<T>::begin() const {
  iterator x;
  if (!empty())
    x.ptr_ = this->head;
  else
...
template <class T> typename list<T>::const_iterator list<T>::end() const {
  const_iterator x;
  x.ptr_ = lock;
  return const_iterator(x);
}
...
template <class T> list<T>::ListIterator::ListIterator() : ptr_(nullptr) {}
template <class T>
list<T>::ListIterator::ListIterator(const ListIterator &other)
    : ptr_(other.ptr_) {}
template <class T> list<T>::ListIterator::~ListIterator() {}
template <class T>
...
list<T>::ListIterator::operator=(const ListIterator &other) noexcept {
  ptr_ = other.ptr_;
  return *this;
};
...
template <class T> const T &list<T>::ListConstIterator::operator*() const {
